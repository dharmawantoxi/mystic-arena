...
KECUALI gornak: renderer/controller/FX-nya adalah rewrite TOTAL v5 di
bosses/gornak_v5.py (kulit ork hijau, satu cleaver + belati, modular
render_* layers, animasi delta-time + spawn/victory/death, FX
world-space lewat _fx_scale, E=100/R=180 px dunia, feel via
heroes/combat_feel.py). level1.py hanya me-re-export _NS_gornak.
Regresi: tools/test_gornak_masterwork.py + tools/test_gornak_v3_combat.py,
sheet: tools/_shot_gornak_v5.py.
...
# ====================================================================
# GORNAK (ANTI-MAGE) - Mini Boss  ·  PIXEL MASTERWORK v5
#
# Renderer + controller + FEEL Gornak yang SESUNGGUHNYA kini hidup di
# bosses/gornak_v5.py (rewrite total dari nol - bukan v4 yang ditambal).
# File ini MENG-RE-EXPORT namespace-nya supaya semua konsumen lama
# (heroes/__init__.py _POSE_CONTROLLER_SPECS/_LIVE_FX_HEROES, tools/
# test_gornak_masterwork.py, tools/test_gornak_v3_combat.py, overlay
# debug) terus bekerja tanpa satu pun nama berubah.
# Regresi: tools/test_gornak_masterwork.py + tools/test_gornak_v3_combat.py.
# ====================================================================
...
from bosses.gornak_v5 import _NS_gornak  # noqa: E402
# ====================================================================
