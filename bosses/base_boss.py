        ...
        if self.target:
            ...
            if dist <= self.range:
                ...
                if self.timer == 0:
                    ...
                    # 19 blok `IMPACT FX <BOSS>` (notify_melee_impact /
                    # notify_projectile_impact) yang dulu berdiri di sini
                    # sudah dibuang: benturan serangan dasar mini boss
                    # tidak boleh memicu flash / shockwave / serpihan /
                    # shake / hit-stop. Impact FX sekarang eksklusif
                    # milik SKILL — lihat blok `SKILL FX <BOSS>` di
                    # _smart_ai_* pada bagian bawah file ini.
