...
- Auto-melee prototipe: tiap tick setelah combat minion, Kaizen biru hidup mengayun target musuh terdekat dalam `eff_attack_range` (unit dulu, lalu bangunan; ikat `<=` seperti Q). Tidak ada pathfinding/gerak.
...
W/E/R, dash visual penuh, respawn timer, item, unlock gold 400, hero merah, pathfinding/gerak, upgrade hero via UI, dan lima hero starter lainnya. Auto-melee prototipe **bukan** port AIPlayer.
