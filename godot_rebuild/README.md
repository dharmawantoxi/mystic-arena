...
- **Kaizen biru** muncul di dekat nexus (bukan pembelian). Auto-melee dalam range, kejar musuh `< 900` px; **klik kanan** tanah = jalan, **klik kanan musuh** = ikuti. **Q** butuh target; **W** Wind Wall; **E** Sweep AOE. Bukan R/retreat atau roster penuh.
