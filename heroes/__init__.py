...
_EXTRA = {
    ...
    'kaizen': [
        ...
        '_draw_kaizen_idle', '_draw_kaizen_walk', '_draw_shadow',
        '_draw_sweep_effect', '_draw_sweep_ground', '_draw_tornado',
        '_draw_tornado_ground', '_draw_wind_arc', '_draw_wind_aura',
        '_draw_wind_platform', '_draw_wind_swirl', '_draw_wind_wall',
        '_ellipse', '_manage_projectiles', '_poly',
        '_rect', '_spawn_wind_slash', '_target_position',
        '_update_attack_anim', 'draw_boss', 'draw_kaizen',
        'math', 'pygame',
    ],
    'thorne': [
