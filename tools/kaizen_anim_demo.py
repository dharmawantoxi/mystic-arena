#!/usr/bin/env python3
# ============================================================
# Demo: sprite-sheet animasi Kaizen (walk, attack, idle)
# ------------------------------------------------------------
# Render frame-frame animasi rig masterwork Kaizen asli,
# berdampingan, untuk melihat & membandingkan kualitas animasi.
#
# Jalankan:
#   SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
#     /home/user/.venv/bin/python tools/kaizen_anim_demo.py
# ============================================================
import os
import sys
...
def render_frame(action, phase, progress=0.0, facing=1, size=120):
    ...
    kz._draw_kaizen_elite(s, size // 2, size // 2, facing, phase, action,
                          progress, True)
    return s
...
def main():
    ...
    path = os.path.join(out, "kaizen_anim_sheet.png")
