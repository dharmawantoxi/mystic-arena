#!/usr/bin/env python3
# ============================================================
# Demo: sprite-sheet animasi Vex (walk, attack, idle)
# ------------------------------------------------------------
# Render frame-frame animasi rig masterwork Vex asli.
#
# Jalankan:
#   SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
#     /home/user/.venv/bin/python tools/vex_anim_demo.py
# ============================================================
import os
import sys
...
def render_frame(action, phase, progress=0.0, facing=1, size=120):
    ...
    sy._draw_vex_elite(s, size // 2, size // 2, facing, phase, action,
                          progress, True)
    return s
...
def main():
    ...
    path = os.path.join(out, "vex_anim_sheet.png")
