...
// Packed* untuk MENJALANKAN splash_processor.cpp di luar engine (self-test).
//
// Meniru SEMANTIK Godot 4.3 yang dipakai kode generated (pola
// godot/gdext/mystic_ui/selftest/godot_stub.hpp):
//
...
//   * Rect2 menyimpan float — posisi/size splash integral sehingga
//     round-trip int(Rect2.position) eksak.
//   * Variant punya operator double()/float() seperti godot-cpp 4.3
//     (include/godot_cpp/variant/variant.hpp:228-229) — dipakai kode
//     generated membaca nilai Dictionary partikel.
//
...
#ifndef MYSTIC_SPLASH_SELFTEST_GODOT_STUB_H
#define MYSTIC_SPLASH_SELFTEST_GODOT_STUB_H
...
public:
    ...
    // godot-cpp 4.3: operator double()/float() (variant.hpp:228-229).
...
#endif // MYSTIC_SPLASH_SELFTEST_GODOT_STUB_H
