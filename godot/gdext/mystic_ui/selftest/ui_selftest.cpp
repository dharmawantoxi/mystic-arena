// ui_selftest.cpp — JALANKAN ui_processor.cpp di luar engine.
//
// Pola godot/gdext/mystic_maps/selftest/maps_selftest.cpp, tapi deklarasi
// kelasnya TIDAK disalin: ui_processor.h ikut di-parse apa adanya (include
...
//   <id>\t<perintah>\t[<arg>\t...]
// Perintah:
//   bind                      — panggil MysticUI::_bind_methods() (memastikan
//                               seluruh bind_static_method bisa dibangun)
//   count                     — jumlah entri tabel perintah (closed-world CI)
//   fn\t<nama>\t<arg>...      — panggil satu fungsi MysticUI dengan argumen
//                               Variant; tabel perintah datang dari
//                               ui_dispatch.inc HASIL GENERATOR, jadi fungsi
...
// Driver Python (tools/test_ui_cpp_selftest.py) membangun perintah dari oracle
// ui_components/_bundle.py + generator dan membandingkan balasannya.
//
// Build + jalan (butuh compiler saja, tanpa godot-cpp):
//   g++ -std=c++17 -O0 -I godot/gdext/mystic_ui/selftest
//       -I godot/gdext/mystic_ui/selftest/shim
//       -o /tmp/ui_selftest godot/gdext/mystic_ui/selftest/ui_selftest.cpp
//   printf 'a\tfn\tbuild_cost\n' | /tmp/ui_selftest   -> a\tint:100
...
// berkas generated.
struct MysticUIBindingProbe : public MysticUI {
    static void run() { MysticUI::_bind_methods(); }
};
