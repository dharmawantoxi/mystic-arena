// mobile_selftest.cpp — JALANKAN mobile_processor.cpp di luar engine.
//
// Pola godot/gdext/mystic_ui/selftest/ui_selftest.cpp, tapi deklarasi
// kelasnya TIDAK disalin: mobile_processor.h ikut di-parse apa adanya (include
// godot-cpp diarahkan ke shim kosong oleh -Ishim + godot_stub.hpp), jadi API
// yang diuji selalu sama dengan API hasil generate.
//
// Protokol: satu perintah per baris di stdin, field dipisah TAB
//   <id>\t<perintah>\t[<arg>\t...]
// Perintah:
//   bind                      — panggil MysticMobile::_bind_methods() (memastikan
//                               seluruh bind_static_method bisa dibangun)
//   count                     — jumlah entri tabel perintah (closed-world CI)
//   fn\t<nama>\t<arg>...      — panggil satu fungsi MysticMobile dengan argumen
//                               Variant; tabel perintah datang dari
//                               mobile_dispatch.inc HASIL GENERATOR, jadi fungsi
//                               baru otomatis bisa diuji tanpa menyunting
//                               berkas ini.
...
// Driver Python (tools/test_mobile_cpp_selftest.py) membangun perintah dari
// oracle mobile/*.py ASLI (di-exec dengan stub pygame) + generator dan
// membandingkan balasannya.
//
// Build + jalan (butuh compiler saja, tanpa godot-cpp):
//   g++ -std=c++17 -O0 -I godot/gdext/mystic_mobile/selftest
//       -I godot/gdext/mystic_mobile/selftest/shim
//       -o /tmp/mobile_selftest godot/gdext/mystic_mobile/selftest/mobile_selftest.cpp
//   printf 'a\tfn\tapi_signature\n' | /tmp/mobile_selftest
//       -> a\tstr:mobile_v1:8mod:66fn:
...
#include "../src/mobile_processor.cpp"
...
// berkas generated.
struct MysticMobileBindingProbe : public MysticMobile {
    static void run() { MysticMobile::_bind_methods(); }
};
...
// ── Konverter argumen (dipakai mobile_dispatch.inc hasil generator) ──────────
