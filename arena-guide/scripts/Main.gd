...
const BASE_RED = Vector2(1180, 180) # L32 rapat dire — dulu (1145,175) spase 35px dari ujung lane (1180,180)
const HERO_SPAWN = Vector2(250, 580)
const INCOME_PER_SEC = 3.0
const SHOP_BLUE = Vector2(340, 540)
const SHOP_RED = Vector2(940, 180)

const LANE_TOP_WP = [Vector2(90, 590), Vector2(85, 460), Vector2(95, 340), Vector2(130, 260), Vector2(175, 185), Vector2(235, 125), Vector2(285, 95), Vector2(380, 75), Vector2(550, 70), Vector2(720, 75), Vector2(880, 85), Vector2(1030, 110), Vector2(1180, 180)] # L32 halus top — tambah 1 wp (235,125) biar tikungan 120,220→39° jadi <19°
const LANE_MID_WP = [Vector2(170, 550), Vector2(280, 450), Vector2(400, 380), Vector2(520, 350), Vector2(640, 340), Vector2(760, 330), Vector2(880, 300), Vector2(1000, 240), Vector2(1110, 170)] # L32 halus mid — kembali ke L30 halus (zigzag pygame 65° → <16°) — patah tengah hilang. Jika mau 100% pygame, pakai [300,420,440,320,580,400...]
const LANE_BOT_WP = [Vector2(130, 630), Vector2(260, 650), Vector2(420, 660), Vector2(600, 660), Vector2(780, 655), Vector2(940, 645), Vector2(1020, 605), Vector2(1090, 535), Vector2(1150, 420), Vector2(1185, 330), Vector2(1190, 250), Vector2(1180, 180)] # L32 halus bot — geser 1070,620→1020,605 + 1170,500→1090,535→1150,420 biar tikungan 39° jadi <23°
const LANE_SMOOTH = [14, 8, 14] # L32 rapat & halus — top/bot 10→14 biar titik 111→155 / 101→141, celah bata tertutup. Mid tetap 8.
